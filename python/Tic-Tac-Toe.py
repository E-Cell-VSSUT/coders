'''
----------------------PROGRAM TO PLAY TIC-TAC-TOE WITH USER----------------------------
Here are the assumptions considered in this program:
-->>The computer (i.e., this program) plays the game using 'X's;
-->>The user plays the game using 'O's;
